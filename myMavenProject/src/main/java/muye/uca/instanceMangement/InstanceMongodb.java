...
public class InstanceMongodb {
    ...
    public  void createInstance(String instanceId){
        ...
        String body = "{\n" +
                ...
                "                                            \""+this.getInstanceId()+"_node_2\"," +
                "                                            \""+this.getInstanceId()+"_node_3\"" +
                "                                        ],\n" +
                "                                        \"GroupId\": \"+this.getInstanceId()+\"node_group1\"\n" +
                "                                    }\n" +
                "                                ],\n" +
                "                                \"SecurityGroups\": [],\n" +
                "                                \"Type\": \"node\",\n" +
                ...
                "                            }\n" +
                "                        ],\n" +
                "                        \"InstanceName\": \""+this.getInstanceId()+"_name\",\n" +
                "                        \"Domain\": \"\",\n" +
    ...
    public static  void main(String[] args) {
        ...
        int count = 0;
        while (flag) {
            InstanceMongodb instance = new InstanceMongodb();
            String instanceId = "myautotest" + System.currentTimeMillis();
